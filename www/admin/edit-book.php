...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "update  tblbooks set BookName=:bookname,CatId=:category,AuthorId=:author,Publisher=:publisher where id=:bookid";
    ...
    <head>
        ...
        <title>VPKBIET COMPUTER DEPARTMENT LIBRARY | Edit Book</title>
                                        ...
                                        foreach ($results as $result) { ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <a
                                                        href="change-bookimg.php?bookid=<?php echo htmlentities($result->bookid); ?>">Change
                                                        Book Image</a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="isbn"
                                                        value="<?php echo htmlentities($result->ISBNNumber); ?>" readonly />
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Publisher in USD<span style="color:red;">*</span></label>
