...
//rename the image file
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            $sql = "INSERT INTO  tblbooks(BookName,CatId,AuthorId,ISBNNumber,Publisher,bookImage) VALUES(:bookname,:category,:author,:isbn,:publisher,:imgnewname)";
    ...
    <head>
        ...
        <title>VPKBIET COMPUTER DEPARTMENT LIBRARY | Add Book</title>
                                ...
                                <form role="form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="publisher" autocomplete="off"
                                                required="required" />
                                        </div>
                                    </div>
